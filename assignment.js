...
let a = 10, b = 20;
console.log("Greater is:", a > b ? a : b);

// 1.4 Check divisible by 5
let num2 = 25;
console.log(num2 % 5 === 0 ? "Divisible by 5" : "Not Divisible");
...
let c = 'i';
if ((c >= 'a' && c <= 'z') || (c >= 'A' && c <= 'Z')) {
  if ('aeiouAEIOU'.includes(c)) console.log("Vowel");
...
let num4 = 16;
if (num4 % 2 === 0) {
  if (num4 % 4 === 0) console.log("Even and divisible by 4");
...
let temp = 35;
if (temp >= 40) console.log("Very Hot");
else if (temp >= 30) console.log("Hot");
else if (temp >= 20) console.log("Warm");
else if (temp >= 10) console.log("Cold");
else console.log("Very Cold");

// 3.5 Divisibility by 2 and/or 3
let num5 = 12;
if (num5 % 2 === 0 && num5 % 3 === 0) console.log("Divisible by both 2 and 3");
else if (num5 % 2 === 0) console.log("Divisible by 2 only");
else if (num5 % 3 === 0) console.log("Divisible by 3 only");
